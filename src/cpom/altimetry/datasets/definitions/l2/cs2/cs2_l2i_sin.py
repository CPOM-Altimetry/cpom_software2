...
dataset_definition = {
    ...
    "latency": "NTC",
    "l2_dir": os.environ["CPDATA_DIR"] + "/SATS/RA/CRY/L2I/SIN",
    "search_pattern": "**/CS*SINI2__*.nc",
    "yyyymm_str_fname_indices": [-39, -31],
    # -------------------#
    # --Core Parameters--#
    # -------------------#
    "lat_param": "lat_poca_20_ku",
    "lon_param": "lon_poca_20_ku",
    "lat_nadir_param": "lat_20_ku",
    "lon_nadir_param": "lon_20_ku",
...
def get_height_3_20_filt(get_var, nc=None):

    elev = get_var("height_3_20_ku")
...
derived_parameters = {"height_3_20_ku_filt": get_height_3_20_filt}
