...
# This time, we will hill-shade the actual dataset values. Note that this
# is an area definition setting, and so is not set in the dataset but
# as an override to the area definition dict within the class initialization

Polarplot("greenland_hs_is", {"apply_hillshade_to_vals": True}).plot_points(
    dataset1, map_only=True, output_file="/tmp/example2b.png"
)
