...
# Antarctica 100m DEM : ATL14 A4 (SE) Sector

"""

area_definition = {
    "long_name": "Antarctica 100m DEM : ATL14 A4 (SE) Sector",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "llcorner_lat": -70.04,  # lower left corner latitude
    "llcorner_lon": 180.0,  # lower left corner longitude
    #   --------
    "lon_0": None,  # None or projection y-axis longitude (used for mercator)
    #   --------
    "width_km": 2790,  # width in km of plot area (x direction)
    "height_km": 2190,  # height in km of plot area (y direction)
    # --------------------------------------------
    ...
    # 3d plot settings
    # ---------------------------------------------
    "dem_name": "alt14_ant_a4_100m_004_004_zarr",  # DEM used for 3d plots in this area
    "smooth_dem": False,
