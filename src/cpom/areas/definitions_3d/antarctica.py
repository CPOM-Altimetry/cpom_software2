...
area_definition = {
    "long_name": "Antarctica DEM: 1km REMA Gapless v1::3",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "llcorner_lat": -50.0,  # lower left corner latitude
    "llcorner_lon": 225.0,  # lower left corner longitude
    #   --------
    "lon_0": None,  # None or projection y-axis longitude (used for mercator)
    #   --------
    "width_km": 5500,  # width in km of plot area (x direction)
    "height_km": 4500,  # height in km of plot area (y direction)
    # --------------------------------------------
