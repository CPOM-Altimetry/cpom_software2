...
area_definition = {
    "long_name": "Antarctica 100m DEM : ATL14 A1 (NE) Sector",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "llcorner_lat": -90,  # lower left corner latitude
    "llcorner_lon": 0.0,  # lower left corner longitude
    #   --------
    "lon_0": None,  # None or projection y-axis longitude (used for mercator)
    #   --------
    "width_km": 2630,  # width in km of plot area (x direction)
    ...
    # 3d plot settings
    # ---------------------------------------------
    "dem_name": "alt14_ant_a1_100m_004_004_zarr",  # DEM used for 3d plots in this area
    "smooth_dem": False,
