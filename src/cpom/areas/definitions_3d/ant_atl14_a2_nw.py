...
# Antarctica DEM: 1km REMA Gapless v1::3

"""

area_definition = {
    "long_name": "Antarctica 100m DEM : ATL14 A2 (NW) Sector",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "llcorner_lat": -65.779,  # lower left corner latitude
    "llcorner_lon": -90.0,  # lower left corner longitude
    #   --------
    "lon_0": None,  # None or projection y-axis longitude (used for mercator)
    #   --------
    "width_km": 2670,  # width in km of plot area (x direction)
    "height_km": 2270,  # height in km of plot area (y direction)
    # --------------------------------------------
    ...
    # 3d plot settings
    # ---------------------------------------------
    # "dem_name": "alt14_ant_a2_100m_004_004_zarr",  # DEM used for 3d plots in this area
    "dem_name": "atl14_ant_100m_004_004_zarr",  # "alt14_ant_a1_100m_004_004_zarr",
    "smooth_dem": False,
