...
area_definition = {
    "long_name": "Rignot Basin 12",
    "area_summary": "Rignot Basin 12",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "minlon": 73.0,  # minimum longitude to initially filter records for area (0..360E)
    "maxlon": 106.0,  # maximum longitude to initially filter records for area (0..360E)
    ...
    "maskname": "rignot_2016_basin_12_polygon_mask",  # from  clev2er.utils.masks.Mask
    "masktype": "polygon",
    ...
    # ------------------------------------------------------
    "longitude_gridlines": [75, 80, 85, 90, 95, 100, 105],  # deg E
    ...
    "mapscale": [
        ...
        89.4,  # longitude of true scale (ie centre of area)
