...
area_definition = {
    "long_name": "EAIS Margin: Test File:0",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    #   --------
    "width_km": 100,  # width in km of plot area (x direction)
    "height_km": 100,  # height in km of plot area (y direction)
    # --------------------------------------------
    # Area characteristics
    # --------------------------------------------
    "min_elevation": -10.0,  # minimum expected elevation in area (m)
    "max_elevation": 3000.0,  # maximum expected elevation in area (m)
    # --------------------------------------------
    ...
    "maxlat": -66.0,  # maximum latitude to initially filter records for area
    # --------------------------------------------
    ...
    "area_long_name_position": (0.27, 0.84),  # for default annotation position of area long name
    "area_long_name_fontsize": 15,  # font size of area.long_name
    ...
    "longitude_gridlines": [124, 126, 128, 130, 132, 134],  # deg E
