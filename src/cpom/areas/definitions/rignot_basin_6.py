...
area_definition = {
    "long_name": "Rignot Basin 6",
    "area_summary": "Rignot Basin 6",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "centre_lon": 67.1,  # degrees E
    "centre_lat": -74.9,  # degrees N
    #   --------
    ...
    #   --------
    "width_km": 1800,  # width in km of plot area (x direction)
    "height_km": 1800,  # height in km of plot area (y direction)
    # --------------------------------------------
    ...
    "minlon": 35.0,  # minimum longitude to initially filter records for area (0..360E)
    "maxlon": 100.0,  # maximum longitude to initially filter records for area (0..360E)
    "minlat": -82.0,  # minimum latitude to initially filter records for area
    ...
    "maskname": "rignot_2016_basin_6_polygon_mask",  # from  clev2er.utils.masks.Mask
    "masktype": "polygon",
    ...
    # ------------------------------------------------------
    "longitude_gridlines": [40, 50, 60, 70, 80, 90],  # deg E
    "latitude_gridlines": [-68, -70, -72, -74, -76, -78, -80, -82],  # deg N
    ...
    "mapscale": [
        ...
        -74.9,  # latitude of true scale (ie centre of area)
        67.1,  # longitude of true scale (ie centre of area)
