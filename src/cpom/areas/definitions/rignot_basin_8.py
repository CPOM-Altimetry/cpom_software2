...
area_definition = {
    "long_name": "Rignot Basin 8 (West J-Jpp)",
    "area_summary": "Rignot Basin 8 (West J-Jpp)",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "centre_lon": 0,  # degrees E
    "centre_lat": -82,  # degrees N
    #   --------
    ...
    #   --------
    "width_km": 2200,  # width in km of plot area (x direction)
    "height_km": 2200,  # height in km of plot area (y direction)
    # --------------------------------------------
    ...
    "maskname": "rignot_2016_basin_8_polygon_mask",  # from  clev2er.utils.masks.Mask
    "masktype": "polygon",
    ...
    # ------------------------------------------------------
    "longitude_gridlines": range(0, 360, 20),  # deg E
