...
area_definition = {
    "long_name": "Rignot Basin 2",
    "area_summary": "Rignot Basin 2",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "minlon": 210.0,  # minimum longitude to initially filter records for area (0..360E)
    "maxlon": 250.0,  # maximum longitude to initially filter records for area (0..360E)
    "minlat": -83.0,  # minimum latitude to initially filter records for area
    ...
    "maskname": "rignot_2016_basin_2_polygon_mask",  # from  clev2er.utils.masks.Mask
    "masktype": "polygon",
    ...
    # ------------------------------------------------------
    "longitude_gridlines": [205, 210, 215, 220, 225, 230, 235, 240],  # deg E
