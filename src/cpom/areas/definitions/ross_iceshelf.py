...
area_definition = {
    "long_name": "Ross Ice Shelf",
    "area_summary": "Ross Ice Shelf",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "centre_lon": 180.0,  # degrees E
    "centre_lat": -82.0,  # degrees N
    #   --------
    ...
    #   --------
    "width_km": 1595,  # width in km of plot area (x direction)
    "height_km": 1595,  # height in km of plot area (y direction)
    # --------------------------------------------
    ...
    "minlon": 95.0,  # minimum longitude to initially filter records for area (0..360E)
    "maxlon": 350.0,  # maximum longitude to initially filter records for area (0..360E)
    "minlat": -88.0,  # minimum latitude to initially filter records for area
    "maxlat": -73.0,  # maximum latitude to initially filter records for area
    # --------------------------------------------
    ...
    # ------------------------------------------------------
    "longitude_gridlines": range(100, 280, 10),  # deg E
    ...
    "show_scalebar": True,
    "mapscale": [
        180.0,  # longitude to position scale bar
        -75.7,  # latitide to position scale bar
        180.0,  # longitude of true scale (ie centre of area)
        -81.0,  # latitude of true scale (ie centre of area)
