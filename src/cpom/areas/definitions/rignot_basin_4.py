...
area_definition = {
    "long_name": "Rignot Basin 4",
    "area_summary": "Rignot Basin 4",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "centre_lon": 141.3,  # degrees E
    "centre_lat": -70.5,  # degrees N
    #   --------
    ...
    #   --------
    "width_km": 1500,  # width in km of plot area (x direction)
    "height_km": 1500,  # height in km of plot area (y direction)
    # --------------------------------------------
    ...
    "minlon": 123.0,  # minimum longitude to initially filter records for area (0..360E)
    "maxlon": 160.0,  # maximum longitude to initially filter records for area (0..360E)
    "minlat": -76.0,  # minimum latitude to initially filter records for area
    ...
    "maskname": "rignot_2016_basin_4_polygon_mask",  # from  clev2er.utils.masks.Mask
    "masktype": "polygon",
    ...
    # ------------------------------------------------------
    "longitude_gridlines": [125, 130, 135, 140, 145, 150, 155, 160],  # deg E
    "latitude_gridlines": [-66, -68, -70, -72, -74, -76],  # deg N
    ...
    "mapscale": [
        ...
        -70.5,  # latitude of true scale (ie centre of area)
        141.3,  # longitude of true scale (ie centre of area)
