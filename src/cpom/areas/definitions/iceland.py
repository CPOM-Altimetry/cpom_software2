...
area_definition = {
    ...
    "centre_lon": -18.85,  # degrees E
    "centre_lat": 64.83,  # degrees N
    #   --------
    ...
    "minlon": 333.0,  # minimum longitude to initially filter records for area (0..360E)
    "maxlon": 348.0,  # maximum longitude to initially filter records for area (0..360E)
    "minlat": 63.0,  # minimum latitude to initially filter records for area
    ...
    "background_image": "natural_earth_gray",  # background image. see clev2er.utils.backgrounds
    ...
    "stats_position_x_offset": 0.01,  # x offset to stats position
