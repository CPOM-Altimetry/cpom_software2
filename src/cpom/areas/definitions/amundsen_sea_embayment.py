...
area_definition = {
    "long_name": "Amundsen Sea Embayment",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "max_elevation": 3000,  # maximum expected elevation in area (m)
    # --------------------------------------------
    ...
    "show_scalebar": True,
    "mapscale": [
        -112.0,  # longitude to position scale bar
        -72.0,  # latitide to position scale bar
        -104.0,  # longitude of true scale (ie centre of area)
        -75.0,  # latitude of true scale (ie centre of area)
        100,  # width of scale bar (km)
        "black",  # color of scale bar
        10,  # size of scale bar
    ],
    # --------------------------------------------------------
    # Histograms
    # --------------------------------------------------------
