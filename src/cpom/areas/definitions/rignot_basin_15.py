...
area_definition = {
    "long_name": "Rignot Basin 15 (Peninsular Ipp-J)",
    "area_summary": "Rignot Basin 15 (Peninsular Ipp-J)",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "centre_lon": 297,  # degrees E
    "centre_lat": -72,  # degrees N
    #   --------
    ...
    #   --------
    "width_km": 760,  # width in km of plot area (x direction)
    "height_km": 760,  # height in km of plot area (y direction)
    # --------------------------------------------
    ...
    "minlon": 250.0,  # minimum longitude to initially filter records for area (0..360E)
    "maxlon": 330.0,  # maximum longitude to initially filter records for area (0..360E)
    "minlat": -78.0,  # minimum latitude to initially filter records for area
    "maxlat": -68.0,  # maximum latitude to initially filter records for area
    # --------------------------------------------
    #    mask from clev2er.utils.masks.Mask
    # --------------------------------------------
    "apply_area_mask_to_data": True,  # filter data using areas clev2er.utils.masks.Mask
    "maskname": "rignot_2016_basin_15_polygon_mask",  # from  clev2er.utils.masks.Mask
    "masktype": "polygon",
    ...
    # ------------------------------------------------------
    "longitude_gridlines": [276, 280, 284, 288, 292, 296, 300, 304, 308],  # deg E
    ...
    "show_scalebar": True,
    "mapscale": [
        307,  # longitude to position scale bar
        -72,  # latitide to position scale bar
        297,  # longitude of true scale (ie centre of area)
        -72,  # latitude of true scale (ie centre of area)
