...
area_definition = {
    ...
    "centre_lon": 12.7,  # degrees E
    "centre_lat": 58.5,  # degrees N
    #   --------
    ...
    #   --------
    "lon_0": 13.61,  # None or projection y-axis longitude (used for mercator)
    #   --------
    "width_km": 140,  # width in km of plot area (x direction)
    "height_km": 140,  # height in km of plot area (y direction)
    # --------------------------------------------
    ...
    "background_image_resolution": "vhigh",  # None, 'low','medium', 'high'
