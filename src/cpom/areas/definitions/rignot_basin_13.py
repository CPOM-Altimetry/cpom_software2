...
area_definition = {
    "long_name": "Rignot Basin 13",
    "area_summary": "Rignot Basin 13",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "centre_lon": 341.4,  # degrees E
    "centre_lat": -74.3,  # degrees N
    #   --------
    ...
    #   --------
    "width_km": 1400,  # width in km of plot area (x direction)
    "height_km": 1400,  # height in km of plot area (y direction)
    # --------------------------------------------
    # Area characteristics
    # --------------------------------------------
    "min_elevation": -50,  # minimum expected elevation in area (m)
    "max_elevation": 3500,  # maximum expected elevation in area (m)
    # --------------------------------------------
    ...
    "minlon": 320.0,  # minimum longitude to initially filter records for area (0..360E)
    "maxlon": 360.0,  # maximum longitude to initially filter records for area (0..360E)
    "minlat": -80.0,  # minimum latitude to initially filter records for area
    "maxlat": -69.0,  # maximum latitude to initially filter records for area
    # --------------------------------------------
    #    mask from clev2er.utils.masks.Mask
    # --------------------------------------------
    "apply_area_mask_to_data": True,  # filter data using areas clev2er.utils.masks.Mask
    "maskname": "rignot_2016_basin_13_polygon_mask",  # from  clev2er.utils.masks.Mask
    "masktype": "polygon",
    ...
    # ------------------------------------------------------
    "longitude_gridlines": [320, 330, 340, 350, 360],  # deg E
    "latitude_gridlines": [-67, -69, -71, -73, -75, -77, -79],  # deg N
    ...
    "mapscale": [
        ...
        -74.0,  # latitude of true scale (ie centre of area)
        -18.0,  # longitude of true scale (ie centre of area)
