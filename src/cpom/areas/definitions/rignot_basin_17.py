...
area_definition = {
    "long_name": "Rignot Basin 17 (West Hp-I)",
    "area_summary": "Rignot Basin 17 (West Hp-I)",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "centre_lon": 288.5,  # degrees E
    "centre_lat": -71.9,  # degrees N
    #   --------
    ...
    "maxlon": 320.0,  # maximum longitude to initially filter records for area (0..360E)
    ...
    "maskname": "rignot_2016_basin_17_polygon_mask",  # from  clev2er.utils.masks.Mask
    "masktype": "polygon",
    ...
    "show_scalebar": True,
    "mapscale": [
        -80.5,  # longitude to position scale bar
        -70,  # latitide to position scale bar
        288.5,  # longitude of true scale (ie centre of area)
        -71.9,  # latitude of true scale (ie centre of area)
