...
area_definition = {
    "long_name": "Rignot Basin 14 (West J-Jpp)",
    "area_summary": "Rignot Basin 14 (West J-Jpp)",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "centre_lon": 280,  # degrees E
    "centre_lat": -81.7,  # degrees N
    #   --------
    ...
    #   --------
    "width_km": 1620,  # width in km of plot area (x direction)
    "height_km": 1620,  # height in km of plot area (y direction)
    # --------------------------------------------
    ...
    "maxlat": -71.0,  # maximum latitude to initially filter records for area
    # --------------------------------------------
    #    mask from clev2er.utils.masks.Mask
    # --------------------------------------------
    "apply_area_mask_to_data": True,  # filter data using areas clev2er.utils.masks.Mask
    "maskname": "rignot_2016_basin_14_polygon_mask",  # from  clev2er.utils.masks.Mask
    "masktype": "polygon",
    ...
    # ------------------------------------------------------
    "longitude_gridlines": range(240, 320, 10),  # deg E
    "latitude_gridlines": range(-85, -55, 5),  # deg N
    ...
    "show_scalebar": True,
    "mapscale": [
        240,  # longitude to position scale bar
        -81.7,  # latitide to position scale bar
        280,  # longitude of true scale (ie centre of area)
        -81.7,  # latitude of true scale (ie centre of area)
        300,  # width of scale bar (km)
        "black",  # color of scale bar
        18,  # size of scale bar
    ],
    # --------------------------------------------------------
    # Histograms
    # --------------------------------------------------------
