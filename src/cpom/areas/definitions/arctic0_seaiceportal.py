...
area_definition = {
    ...
    "epsg_number": 3995,  # EPSG number for area's projection
    #   --------
    ...
    #   --------
    "lon_0": 0.0,  # None or projection y-axis longitude (used for mercator)
    #   --------
    ...
    "minlat": 58.0,  # minimum latitude to initially filter records for area
    ...
    "axes": [  # define plot axis position
        0.05,  # left
        0.1,  # bottom
        0.756,  # width (axes fraction)
        0.756,  # height (axes fraction)
    ],
    ...
    "background_image": "natural_earth_faded",  # background image. see cpom.backgrounds
    ...
    "area_long_name_position": (0.45, 0.92),  # for default annotation position of area long name
    "area_long_name_fontsize": 20,  # font size of area.long_name
    ...
    "stats_position_y_offset": 0.01,  # y offset to stats position
    ...
    "latitude_gridlines": list(range(60, 80 + 4, 4)),  # deg N
    ...
    "mapscale": [
        ...
        64.3,  # latitide to position scale bar
        9.0,  # longitude of true scale (ie centre of area)
        45.5,  # latitude of true scale (ie centre of area)
        500,  # width of scale bar (km)
