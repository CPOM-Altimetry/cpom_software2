...
area_definition = {
    "long_name": "Rignot Basin 10",
    "area_summary": "Rignot Basin 10",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "centre_lon": 151.0,  # degrees E
    "centre_lat": -74.1,  # degrees N
    #   --------
    ...
    "minlon": 120.0,  # minimum longitude to initially filter records for area (0..360E)
    "maxlon": 175.0,  # maximum longitude to initially filter records for area (0..360E)
    "minlat": -79.0,  # minimum latitude to initially filter records for area
    "maxlat": -67.0,  # maximum latitude to initially filter records for area
    # --------------------------------------------
    #    mask from clev2er.utils.masks.Mask
    # --------------------------------------------
    "apply_area_mask_to_data": True,  # filter data using areas clev2er.utils.masks.Mask
    "maskname": "rignot_2016_basin_10_polygon_mask",  # from  clev2er.utils.masks.Mask
    "masktype": "polygon",
    ...
    # ------------------------------------------------------
    "longitude_gridlines": [120, 130, 140, 150, 160, 170],  # deg E
    ...
    "mapscale": [
        ...
        -74.1,  # latitude of true scale (ie centre of area)
        151.0,  # longitude of true scale (ie centre of area)
