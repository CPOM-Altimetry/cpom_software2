...
area_definition = {
    "long_name": "Rignot Basin 7",
    "area_summary": "Rignot Basin 7",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "centre_lon": 16.5,  # degrees E
    "centre_lat": -73.0,  # degrees N
    #   --------
    ...
    #   --------
    "width_km": 1700,  # width in km of plot area (x direction)
    "height_km": 1700,  # height in km of plot area (y direction)
    # --------------------------------------------
    ...
    "maskname": "rignot_2016_basin_7_polygon_mask",  # from  clev2er.utils.masks.Mask
    "masktype": "polygon",
    ...
    # ------------------------------------------------------
    "longitude_gridlines": [0, 10, 20, 30, 40],  # deg E
    ...
    "mapscale": [
        ...
        -73.0,  # latitude of true scale (ie centre of area)
        16.5,  # longitude of true scale (ie centre of area)
