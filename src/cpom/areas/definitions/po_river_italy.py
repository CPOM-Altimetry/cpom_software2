...
area_definition = {
    ...
    "centre_lon": 10.52,  # degrees E
    "centre_lat": 44.92,  # degrees N
    #   --------
    "specify_plot_area_by_lowerleft_corner": False,  # specify by lower left corner, w,h
    "llcorner_lat": 58.7,  # lower left corner latitude
    "llcorner_lon": 12.7,  # lower left corner longitude
    #   --------
    "lon_0": 10.52,  # None or projection y-axis longitude (used for mercator)
    #   --------
    "width_km": 6,  # width in km of plot area (x direction)
    "height_km": 6,  # height in km of plot area (y direction)
    # --------------------------------------------
    ...
    "axes": [  # define plot axis position
        0.0,  # left
        0.1,  # bottom
        0.7,  # width (axes fraction)
        0.7,  # height (axes fraction)
    ],
    ...
    "background_image_resolution": "vvhigh",  # None, 'low','medium', 'high'
    ...
    "area_long_name_position": (0.3, 0.83),  # for default annotation position of area long name
    ...
    "stats_position_x_offset": 0.45,  # x offset to stats position
    "stats_position_y_offset": 0.76,  # y offset to stats position
    "stats_position_x_offset_simple": -0.18,  # x offset to stats when plotting map_only
    ...
    "bad_data_minimap_axes": [  # define minimap axis position
        0.69,  # left
        0.67,  # bottom
        0.21,  # width (axes fraction)
        0.21,  # height (axes fraction)
    ],
    ...
    "bad_data_latitude_lines": [56, 58, 60],  # latitude lines to draw in bad data minimap
    ...
    "bad_data_minimap_legend_pos": (1.65, 1.1),  # position of minimap legend (upper right)
