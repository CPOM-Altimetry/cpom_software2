...
area_definition = {
    "long_name": "AIS LRM test track: Test File:0",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "centre_lon": -84,  # degrees E
    "centre_lat": -89,  # degrees N
    #   --------
    ...
    # ------------------------------------------------------
    "latitude_gridlines": [-86, -88],  # deg N
    "longitude_gridlines": range(0, 380, 20),  # deg E
