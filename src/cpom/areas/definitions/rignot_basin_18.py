...
area_definition = {
    "long_name": "Rignot Basin 18",
    "area_summary": "Rignot Basin 18",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "centre_lon": -133.5,  # degrees E
    "centre_lat": -81.0,  # degrees N
    #   --------
    ...
    "minlon": 180.0,  # minimum longitude to initially filter records for area (0..360E)
    "maxlon": 280.0,  # maximum longitude to initially filter records for area (0..360E)
    ...
    "maskname": "rignot_2016_basin_18_polygon_mask",  # from  clev2er.utils.masks.Mask
    "masktype": "polygon",
    ...
    "show_scalebar": True,
    "mapscale": [
        -136.0,  # longitude to position scale bar
        -73.8,  # latitide to position scale bar
        -133.0,  # longitude of true scale (ie centre of area)
