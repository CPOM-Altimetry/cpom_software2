...
area_definition = {
    ...
    "centre_lon": 13.61,  # degrees E
    "centre_lat": 58.7,  # degrees N
    #   --------
    "specify_plot_area_by_lowerleft_corner": False,  # specify by lower left corner, w,h
    "llcorner_lat": 58.7,  # lower left corner latitude
    "llcorner_lon": 13.61,  # lower left corner longitude
    #   --------
    "lon_0": 13.61,  # None or projection y-axis longitude (used for mercator)
    #   --------
    "width_km": 2700,  # width in km of plot area (x direction)
    "height_km": 2700,  # height in km of plot area (y direction)
    # --------------------------------------------
