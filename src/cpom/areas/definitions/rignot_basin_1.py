...
area_definition = {
    "long_name": "Rignot Basin 1 (West H-Hp)",
    "area_summary": "Rignot Basin 1 (West H-Hp)",
    # --------------------------------------------
    # Area definition
    # --------------------------------------------
    ...
    "centre_lon": 268.5,  # degrees E
    "centre_lat": -74.0,  # degrees N
    #   --------
    ...
    "maxlon": 290.0,  # maximum longitude to initially filter records for area (0..360E)
    ...
    "maskname": "rignot_2016_basin_1_polygon_mask",  # from  clev2er.utils.masks.Mask
    "masktype": "polygon",
    ...
    # ------------------------------------------------------
    "longitude_gridlines": [258, 262, 266, 270, 274, 278, 282],  # deg E
    ...
    "show_scalebar": True,
    "mapscale": [
        260.0,  # longitude to position scale bar
        -70.8,  # latitide to position scale bar
        268.5,  # longitude of true scale (ie centre of area)
